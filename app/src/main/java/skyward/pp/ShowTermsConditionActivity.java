...
public class ShowTermsConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_termscondition);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ShowTermsConditionActivity.this, DashboardActivity.class);
                startActivity(i);
                finish();
        ...
        termsc = (TextView) findViewById(R.id.show_tc);

        if (!Utility.isInternetConnected(ShowTermsConditionActivity.this)) {

            Toast.makeText(ShowTermsConditionActivity.this, "Please Check your Internet Connection and come again!", Toast.LENGTH_SHORT).show();
    ...
    class FetchServiceDetails extends AsyncTask<Void, Void, SoapObject> {
        ...
        protected void onPreExecute() {
            ...
            progress = new ProgressDialog(ShowTermsConditionActivity.this);
        ...
        protected void onPostExecute(SoapObject result) {
            ...
            if(result != null) {
                try {
                    ...
                    if (soapObject.getProperty("IsSucceed").toString().equals("true")) {
                        ...
                        for (int i = 0; i < count; i++) {
                            ...
                            TC = soapResult.getPrimitivePropertySafelyAsString("TermsandConditions")
                                    .toString();


                        }
                        termsc.setText(TC);
                        termsc.setMovementMethod(new ScrollingMovementMethod());
                ...
                Toast.makeText(ShowTermsConditionActivity.this, "Check your Internet Connection", Toast.LENGTH_SHORT).show();
            }
        }
