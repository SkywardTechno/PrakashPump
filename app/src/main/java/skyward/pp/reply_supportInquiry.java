...
public class reply_supportInquiry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reply_support_inquiry);

        mail_to= (TextView) findViewById(R.id.rSIMail_to);
        mail_cc= (TextView) findViewById(R.id.rSIMail_cc);
        mail_bcc= (TextView) findViewById(R.id.rSIMail_bcc);
        mail_subject= (TextView) findViewById(R.id.rSIMail_subject);
        mail_compose= (TextView) findViewById(R.id.rSIMail_compose);
        mail_attach= (TextView) findViewById(R.id.rSIMail_attachments);

        setTitle("Support Inquiry");
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("Support Inquiry");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(reply_supportInquiry.this, SupportInquiryListActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        if (!Utility.isInternetConnected(reply_supportInquiry.this)) {

            Toast.makeText(reply_supportInquiry.this, "Please Check your Internet Connection and come again!", Toast.LENGTH_SHORT).show();
    ...
    class FetchOrderDetailstask extends AsyncTask<Void, Void, SoapObject> {
            ...
            try {
                try {
                    ...
                    myAndroidHttpTransport.call(Utility.SOAP_ACTION
                            + Utility.GET_SUPPORTREPLY, mySoapEnvelop);
        ...
        protected void onPostExecute(SoapObject result) {
            ...
            if(result != null) {
                ...
                Toast.makeText(reply_supportInquiry.this, "Check your Internet Connection", Toast.LENGTH_SHORT).show();
            }
        }
    }
